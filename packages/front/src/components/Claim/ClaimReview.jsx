...
class ClaimReviewForm extends Component {
  ...
  onChangeCaptcha() {
    this.setState({recaptcha: recaptchaRef.current.getValue()}, this.toggleDisabledSubmit);
  }

  onChangeClassification(e) {
    if (e.target.value) {
      this.setState({classification: e.target.value}, this.toggleDisabledSubmit);
    }
  }
  ...
  toggleDisabledSubmit(){
    const recaptcha = this.state.recaptcha ? true : false;
    const classification = this.state.classification ? true : false;
          ...
          <Container>
            ...
            <Form onSubmit={this.onSubmit}>
              <FormGroup>
                ...
                />
                <Button type="submit" value="Submit" disabled={this.state.disableSubmit}>Submit</Button>
              </FormGroup>
            </Form>
          </Container> 
        )
