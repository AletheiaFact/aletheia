...
- Go to User Management in Identity Schema and click on Duplicate Identity Schema. Then, update the current schema with the code below and click Save after making the changes:
```
{
