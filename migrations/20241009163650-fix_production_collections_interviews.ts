...
export async function up(db: Db) {
    try {
        await db.collection("logs").insertOne({
            ...
            date: new Date(),
            context:
                "migration-up 20241009163650-fix_production_collections_interviews.ts",
            type: "info",
        });
        ...
        await db.collection("logs").insertOne({
            ...
            date: new Date(),
            context:
                "migration-up 20230425092159-fix_production_collections.ts",
            type: "error",
        });
        throw error;
    }
...
export async function down(db: Db) {
    try {
        await db.collection("logs").insertOne({
            ...
            date: new Date(),
            context:
                "migration-down 20230425092159-fix_production_collections.ts",
            type: "info",
        });
