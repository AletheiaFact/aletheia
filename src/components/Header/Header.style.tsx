...
const BoxMenuHeader = styled(Box)`
    ...
    .menu-header-avatar {
        ...
        border: 2px solid
            ${({ $isSidebar }) =>
                $isSidebar ? colors.neutral : colors.lightNeutral};
    }
    ...
    .menu-header-info.name {
        color: ${({ $isSidebar }) =>
            $isSidebar ? colors.white : colors.black};
        font-weight: 600;
    }

    .menu-header-info.title-namespace {
        color: ${({ $isSidebar }) =>
            $isSidebar ? colors.lightSecondary : colors.black};
    }

    .menu-header-info.email {
        font-size: 12px;
        color: ${({ $isSidebar }) =>
            $isSidebar ? colors.neutralTertiary : colors.neutral};
    }
