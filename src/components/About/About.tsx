        ...
        >
            ...
            <Row style={paragraphStyle}>
                <Trans
                    ...
                    components={[
                        <a style={{whiteSpace: "pre-wrap"}} href="https://wikipedia.org" target="_blank" rel="noreferrer"></a>,
                        <a style={{whiteSpace: "pre-wrap"}} href="https://demagog.cz/" target="_blank" rel="noreferrer"></a>
                    ]}
                />
            </Row>
            <Row style={paragraphStyle}>
            ...
            <Row style={paragraphStyle}>
                <Trans
                    ...
                    components={[
                        ...
                        <a style={{whiteSpace: "pre-wrap"}} href="https://builders.mozilla.community/programs.html#open-lab" target="_blank" rel="noreferrer"></a>,
                        <a style={{whiteSpace: "pre-wrap"}} href="https://www.figma.com/proto/J6OY3ZQILdR7H1qCWyqVw7/Aletheia?node-id=670%3A3370&viewport=849%2C517%2C0.33680295944213867&scaling=scale-down" target="_blank" rel="noreferrer"></a>
                    ]}
                />
            </Row>
        </Row>
