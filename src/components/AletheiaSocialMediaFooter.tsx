...
const AletheiaSocialMediaFooter = () => {
    return (
        ...
        >
            ...
            <SocialIcon url="https://www.linkedin.com/company/aletheiafact-org" bgColor={colors.white} />
            <SocialIcon url="https://github.com/AletheiaFact/aletheia" bgColor={colors.white} />
        </Row>
    );
}
