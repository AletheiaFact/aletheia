...
const VerificationRequestBoardView = ({ state, actions }) => {
    ...
    const statuses = [
        {
            key: VerificationRequestStatus.PRE_TRIAGE,
            label: t("verificationRequest:PRE_TRIAGE"),
        },
        {
            key: VerificationRequestStatus.IN_TRIAGE,
            label: t("verificationRequest:IN_TRIAGE"),
        },
        {
            key: VerificationRequestStatus.POSTED,
            label: t("verificationRequest:POSTED"),
        },
    ];
    ...
    const formatStatusToTranslationKey = (key: string) =>
        key.replace(/\s+/g, "");
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    <Chip
                                        label={
                                            groupedRequests[status.key].length
                                        }
                                        size="small"
                                        sx={{ ml: 1 }}
                                    />
                                    <InfoTooltip
                                        placement="bottom"
                                        content={t(
                                            `verificationRequest:${formatStatusToTranslationKey(
                                                status.key
                                            )}Description`
                                        )}
                            ...
                            {loading[status.key] ? (
                                ...
                                >
                                    {groupedRequests[status.key].map(
                                        (request, index) => (
                                            <Card
                                                key={request._id}
                                                sx={{
                                    ...
                                    {groupedTotalRequests[status.key] >
                                        paginationModel[status.key]
                                            .pageSize && (
                                        <AletheiaButton
                                            ...
                                            data-cy={
                                                "testLoadMoreVerificationRequest"
                                            }
                                        >
                                    ...
                                    {groupedTotalRequests[status.key] === 0 && (
                                        ...
                                        >
                                            {t(
                                                "verificationRequest:noRequestsInStatus"
                                            )}
                                        </Typography>
                                    )}
                                </Box>
