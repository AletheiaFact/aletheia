...
const HistoryListItem = ({ history }: IHistoryListItemProps) => {
    ...
    let title = history.details.after?.[titleTag]
        ? history.details.after?.[titleTag]
        : "";
    const oldTitle = history.details.before?.[titleTag]
        ? history.details.before?.[titleTag]
        : "";
