...
ENV NEXT_PUBLIC_UMAMI_SITE_ID=$NEXT_PUBLIC_UMAMI_SITE_ID
...
ENV NEXT_PUBLIC_ORYCLOUD=$NEXT_PUBLIC_ORYCLOUD
ENV NEXT_PUBLIC_ENABLE_BANNER_DONATION=$NEXT_PUBLIC_ENABLE_BANNER_DONATION
RUN yarn build
